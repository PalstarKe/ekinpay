        ...
        <div class="col-sm-12">
            <div class="row">
                ...
                <div class="col-xl-9">
                    ...
                    {{--<div id="tracker-settings" class="card mb-3">
                        <div class="card-header">
                    ...
                    {{--<div id="zoom-settings" class="card mb-3">
                        <div class="card-header">
                    ...
                    <!--Slack Settings-->
                    {{--<div id="slack-settings" class="card mb-3">
                        <div class="card-header">
                    ...
                    <!--Telegram Settings-->
                    <div id="telegram-settings" class="card mb-3">
                        <div class="card-header">
                    ...
                    <div id="email-notification-settings" class="card mb-3">
                        <div class="col-md-12">
                            <div class="card-header">
                    ...
                    <div id="noc-settings" class="card mb-3">
                        <div class="col-md-12">
                    ...
                    <div id="google-calender" class="card mb-3">
                        <div class="col-md-12">
