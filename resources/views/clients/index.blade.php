...
{{--                                            </a>--}}
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <a href="#" data-size="md" data-url="{{ route('clients.create') }}" data-ajax-popup="true"  data-bs-toggle="tooltip" data-bs-original-title="{{__('Create New Client')}}"  class="btn-addnew-project border-primary">
                        <div class="bg-primary proj-add-icon my-4">
                            <i class="ti ti-plus"></i>
                        </div>
                        <h6 class="mt-4 mb-2">{{  __('Create Client') }}</h6>
